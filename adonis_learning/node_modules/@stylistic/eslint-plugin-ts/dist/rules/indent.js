      ...
      ConditionalExpression(node) {
        ...
        if (!options.flatTernaryExpressions || !utils.isTokenOnSameLine(node.test, node.consequent) || isOnFirstLineOfStatement(firstToken, node)) {
          ...
          offsets.setDesiredOffset(
            ...
            firstToken,
            (firstConsequentToken.type === "Punctuator" || node.consequent.type === "CallExpression") && options.offsetTernaryExpressions ? 2 : 1
          );
          if (lastConsequentToken.loc.end.line === firstAlternateToken.loc.start.line) {
            ...
            offsets.setDesiredOffset(
              firstAlternateToken,
              firstToken,
              (firstAlternateToken.type === "Punctuator" || node.alternate.type === "CallExpression") && options.offsetTernaryExpressions ? 2 : 1
            );
          }
        }
      },
